     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 dc 13 00 00       	push   $0x13dc
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 dc 13 00 00       	push   $0x13dc
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     546:	50                   	push   %eax
     547:	68 d4 13 00 00       	push   $0x13d4
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     565:	50                   	push   %eax
     566:	68 dc 13 00 00       	push   $0x13dc
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 dc 13 00 00       	push   $0x13dc
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1101:	a1 64 14 00 00       	mov    0x1464,%eax
{
  ...
  freep = p;
    ...
    113f:	5b                   	pop    %ebx
  freep = p;
    1140:	a3 64 14 00 00       	mov    %eax,0x1464
}
    1145:	5e                   	pop    %esi
    1146:	5f                   	pop    %edi
    1147:	5d                   	pop    %ebp
    ...
    1156:	72 ce                	jb     1126 <free+0x26>
{
  ...
  freep = p;
    117a:	a3 64 14 00 00       	mov    %eax,0x1464
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    119c:	8b 15 64 14 00 00    	mov    0x1464,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11db:	3b 05 64 14 00 00    	cmp    0x1464,%eax
  ...
  return freep;
    1203:	8b 15 64 14 00 00    	mov    0x1464,%edx
    ...
    122c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    122f:	89 15 64 14 00 00    	mov    %edx,0x1464
}
    ...
    123f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    1240:	c7 05 64 14 00 00 68 	movl   $0x1468,0x1464
    1247:	14 00 00 
    base.s.size = 0;
    124a:	b8 68 14 00 00       	mov    $0x1468,%eax
    base.s.ptr = freep = prevp = &base;
    124f:	c7 05 68 14 00 00 68 	movl   $0x1468,0x1468
    1256:	14 00 00 
    base.s.size = 0;
    1259:	c7 05 6c 14 00 00 00 	movl   $0x0,0x146c
    1260:	00 00 00 
    if(p->s.size >= nunits){
