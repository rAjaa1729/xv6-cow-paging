...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12b:	ff 35 48 55 00 00    	push   0x5548
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1bf:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1d6:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1ed:	ff 35 48 55 00 00    	push   0x5548
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 48 55 00 00    	push   0x5548
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     285:	ff 35 48 55 00 00    	push   0x5548
     ...
     2a0:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "fork failed\n");
     ...
     2b7:	ff 35 48 55 00 00    	push   0x5548
    ...
    exit();
     ...
     2ce:	ff 35 48 55 00 00    	push   0x5548
     ...
     2e5:	ff 35 48 55 00 00    	push   0x5548
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     30b:	ff 35 48 55 00 00    	push   0x5548
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     356:	ff 35 48 55 00 00    	push   0x5548
  ...
  printf(stdout, "openiput test ok\n");
     ...
     39a:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "fork failed\n");
     ...
     3bc:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3d3:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "unlink failed\n");
     ...
     3ea:	ff 35 48 55 00 00    	push   0x5548
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 48 55 00 00    	push   0x5548
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     47f:	ff 35 48 55 00 00    	push   0x5548
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 48 55 00 00    	push   0x5548
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 48 55 00 00    	push   0x5548
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 48 55 00 00    	push   0x5548
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 48 55 00 00    	push   0x5548
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 48 55 00 00    	push   0x5548
     ...
     5de:	ff 35 48 55 00 00    	push   0x5548
     ...
     5f7:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     60e:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "read failed\n");
     ...
     625:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "unlink small failed\n");
     ...
     63c:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     653:	ff 35 48 55 00 00    	push   0x5548
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 48 55 00 00    	push   0x5548
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     6b3:	89 1d 80 7c 00 00    	mov    %ebx,0x7c80
    if(write(fd, buf, 512) != 512){
     6b9:	68 00 02 00 00       	push   $0x200
     6be:	68 80 7c 00 00       	push   $0x7c80
     6c3:	56                   	push   %esi
  ...
  n = 0;
    ...
    if(((int*)buf)[0] != n){
     71b:	a1 80 7c 00 00       	mov    0x7c80,%eax
    ...
    i = read(fd, buf, 512);
     ...
     72f:	68 80 7c 00 00       	push   $0x7c80
     734:	53                   	push   %ebx
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 48 55 00 00    	push   0x5548
     ...
     793:	ff 35 48 55 00 00    	push   0x5548
     ...
     7aa:	ff 35 48 55 00 00    	push   0x5548
     ...
     7c3:	ff 35 48 55 00 00    	push   0x5548
     ...
     7de:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7f5:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     80c:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "unlink big failed\n");
     ...
     823:	ff 35 48 55 00 00    	push   0x5548
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 48 55 00 00    	push   0x5548
     857:	e8 d4 31 00 00       	call   3a30 <printf>
  name[0] = 'a';
     85c:	c6 05 70 7c 00 00 61 	movb   $0x61,0x7c70
  name[2] = '\0';
     863:	83 c4 10             	add    $0x10,%esp
     866:	c6 05 72 7c 00 00 00 	movb   $0x0,0x7c72
  for(i = 0; i < 52; i++){
     86d:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open(name, O_CREATE|O_RDWR);
     870:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     873:	88 1d 71 7c 00 00    	mov    %bl,0x7c71
  for(i = 0; i < 52; i++){
     879:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     87c:	68 02 02 00 00       	push   $0x202
     881:	68 70 7c 00 00       	push   $0x7c70
  ...
  name[0] = 'a';
     89b:	c6 05 70 7c 00 00 61 	movb   $0x61,0x7c70
  name[2] = '\0';
     8a2:	bb 30 00 00 00       	mov    $0x30,%ebx
     8a7:	c6 05 72 7c 00 00 00 	movb   $0x0,0x7c72
  for(i = 0; i < 52; i++){
     8ae:	66 90                	xchg   %ax,%ax
    unlink(name);
     8b0:	83 ec 0c             	sub    $0xc,%esp
    name[1] = '0' + i;
     8b3:	88 1d 71 7c 00 00    	mov    %bl,0x7c71
  for(i = 0; i < 52; i++){
     8b9:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     8bc:	68 70 7c 00 00       	push   $0x7c70
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 48 55 00 00    	push   0x5548
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     8fb:	ff 35 48 55 00 00    	push   0x5548
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     98f:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9a6:	ff 35 48 55 00 00    	push   0x5548
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9bd:	ff 35 48 55 00 00    	push   0x5548
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 48 55 00 00    	push   0x5548
     9e1:	e8 4a 30 00 00       	call   3a30 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 4c 55 00 00       	push   $0x554c
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 48 55 00 00    	push   0x5548
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a6a:	57                   	push   %edi
     a6b:	68 80 7c 00 00       	push   $0x7c80
     ...
     a87:	32 05 80 7c 00 00    	xor    0x7c80,%al
     ...
     aa0:	38 90 80 7c 00 00    	cmp    %dl,0x7c80(%eax)
  ...
  seq = 0;
    ...
    close(fds[0]);
     ...
     afb:	83 c0 01             	add    $0x1,%eax
        buf[i] = seq++;
     afe:	88 90 7f 7c 00 00    	mov    %dl,0x7c7f(%eax)
      for(i = 0; i < 1033; i++)
     ...
     b19:	68 80 7c 00 00       	push   $0x7c80
...
00000bc0 <preempt>:
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c6b:	68 80 7c 00 00       	push   $0x7c80
    ...
    1036:	31 db                	xor    %ebx,%ebx
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    10d8:	68 80 7c 00 00       	push   $0x7c80
    ...
    10f2:	0f be 8a 80 7c 00 00 	movsbl 0x7c80(%edx),%ecx
  ...
  printf(1, "fourfiles ok\n");
    ...
    11a1:	68 80 7c 00 00       	push   $0x7c80
    ...
    11b6:	68 80 7c 00 00       	push   $0x7c80
    11bb:	56                   	push   %esi
...
00001430 <unlinkread>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14e1:	68 80 7c 00 00       	push   $0x7c80
    14e6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    14f8:	80 3d 80 7c 00 00 68 	cmpb   $0x68,0x7c80
    14ff:	75 6b                	jne    156c <unlinkread+0x13c>
  if(write(fd, buf, 10) != 10){
    1501:	83 ec 04             	sub    $0x4,%esp
    1504:	6a 0a                	push   $0xa
    1506:	68 80 7c 00 00       	push   $0x7c80
    150b:	53                   	push   %ebx
...
000015c0 <linktest>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1694:	68 80 7c 00 00       	push   $0x7c80
    1699:	50                   	push   %eax
...
00001d10 <subdir>:
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e06:	68 80 7c 00 00       	push   $0x7c80
    1e0b:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e1d:	80 3d 80 7c 00 00 66 	cmpb   $0x66,0x7c80
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f05:	68 80 7c 00 00       	push   $0x7c80
    1f0a:	50                   	push   %eax
...
000023f0 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    243e:	53                   	push   %ebx
    243f:	68 80 7c 00 00       	push   $0x7c80
    2444:	50                   	push   %eax
    ...
    2454:	53                   	push   %ebx
    2455:	68 80 7c 00 00       	push   $0x7c80
    245a:	56                   	push   %esi
...
000024d0 <bigfile>:
{
  ...
  for(i = 0; ; i++){
    ...
    258d:	0f be 05 80 7c 00 00 	movsbl 0x7c80,%eax
    2594:	d1 fa                	sar    %edx
    2596:	39 d0                	cmp    %edx,%eax
    2598:	75 6e                	jne    2608 <bigfile+0x138>
    259a:	0f be 15 ab 7d 00 00 	movsbl 0x7dab,%edx
  ...
  for(i = 0; ; i++){
    ...
    25b6:	68 80 7c 00 00       	push   $0x7c80
    25bb:	56                   	push   %esi
    ...
    2d35:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d40:	ff 35 48 55 00 00    	push   0x5548
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2faa:	ff 35 48 55 00 00    	push   0x5548
    ...
    302e:	ff 35 48 55 00 00    	push   0x5548
    ...
    3049:	ff 35 48 55 00 00    	push   0x5548
    ...
    3063:	ff 35 48 55 00 00    	push   0x5548
    ...
    3082:	ff 35 48 55 00 00    	push   0x5548
    ...
    3099:	ff 35 48 55 00 00    	push   0x5548
    ...
    30b0:	ff 35 48 55 00 00    	push   0x5548
    ...
    30c7:	ff 35 48 55 00 00    	push   0x5548
    ...
    30de:	ff 35 48 55 00 00    	push   0x5548
    ...
    310d:	ff 35 48 55 00 00    	push   0x5548
    ...
    3124:	ff 35 48 55 00 00    	push   0x5548
    ...
    313b:	ff 35 48 55 00 00    	push   0x5548
    ...
    3152:	ff 35 48 55 00 00    	push   0x5548
    ...
    3184:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    318f:	ff 35 48 55 00 00    	push   0x5548
  ...
  printf(stdout, "validate ok\n");
    ...
    31f9:	ff 35 48 55 00 00    	push   0x5548
    ...
    321b:	ff 35 48 55 00 00    	push   0x5548
...
00003230 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    323b:	ff 35 48 55 00 00    	push   0x5548
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    324f:	90                   	nop
    if(uninit[i] != '\0'){
    3250:	80 b8 60 55 00 00 00 	cmpb   $0x0,0x5560(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    326b:	ff 35 48 55 00 00    	push   0x5548
    ...
    3283:	ff 35 48 55 00 00    	push   0x5548
...
000032a0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32fb:	c7 04 85 80 9c 00 00 	movl   $0x53a8,0x9c80(,%eax,4)
    3302:	a8 53 00 00 
    for(i = 0; i < MAXARG-1; i++)
    3306:	b8 01 00 00 00       	mov    $0x1,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    330b:	c7 04 85 80 9c 00 00 	movl   $0x53a8,0x9c80(,%eax,4)
    3312:	a8 53 00 00 
    3316:	c7 04 85 84 9c 00 00 	movl   $0x53a8,0x9c84(,%eax,4)
    331d:	a8 53 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    3332:	ff 35 48 55 00 00    	push   0x5548
    args[MAXARG-1] = 0;
    3338:	89 0d fc 9c 00 00    	mov    %ecx,0x9cfc
    printf(stdout, "bigarg test\n");
    333e:	e8 ed 06 00 00       	call   3a30 <printf>
    exec("echo", args);
    3343:	58                   	pop    %eax
    3344:	5a                   	pop    %edx
    3345:	68 80 9c 00 00       	push   $0x9c80
    ...
    335b:	ff 35 48 55 00 00    	push   0x5548
    ...
    338b:	ff 35 48 55 00 00    	push   0x5548
    ...
    33a2:	ff 35 48 55 00 00    	push   0x5548
    ...
    33c5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    348a:	68 80 7c 00 00       	push   $0x7c80
    348f:	57                   	push   %edi
...
00003670 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3670:	69 05 44 55 00 00 0d 	imul   $0x19660d,0x5544,%eax
    3677:	66 19 00 
    367a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    367f:	a3 44 55 00 00       	mov    %eax,0x5544
}
    3684:	c3                   	ret
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3bc1:	a1 00 9d 00 00       	mov    0x9d00,%eax
{
  ...
  freep = p;
    ...
    3bff:	5b                   	pop    %ebx
  freep = p;
    3c00:	a3 00 9d 00 00       	mov    %eax,0x9d00
}
    3c05:	5e                   	pop    %esi
    3c06:	5f                   	pop    %edi
    3c07:	5d                   	pop    %ebp
    ...
    3c16:	72 ce                	jb     3be6 <free+0x26>
{
  ...
  freep = p;
    3c3a:	a3 00 9d 00 00       	mov    %eax,0x9d00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3c5c:	8b 15 00 9d 00 00    	mov    0x9d00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3c9b:	3b 05 00 9d 00 00    	cmp    0x9d00,%eax
  ...
  return freep;
    3cc3:	8b 15 00 9d 00 00    	mov    0x9d00,%edx
    ...
    3cec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3cef:	89 15 00 9d 00 00    	mov    %edx,0x9d00
}
    ...
    3cff:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    3d00:	c7 05 00 9d 00 00 04 	movl   $0x9d04,0x9d00
    3d07:	9d 00 00 
    base.s.size = 0;
    3d0a:	b8 04 9d 00 00       	mov    $0x9d04,%eax
    base.s.ptr = freep = prevp = &base;
    3d0f:	c7 05 04 9d 00 00 04 	movl   $0x9d04,0x9d04
    3d16:	9d 00 00 
    base.s.size = 0;
    3d19:	c7 05 08 9d 00 00 00 	movl   $0x0,0x9d08
    3d20:	00 00 00 
    if(p->s.size >= nunits){
