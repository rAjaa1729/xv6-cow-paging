...
void            write_pag_to_disk(uint dev, char* page,uint block_id);
...
// void            make_other_pte_swapped_out(pte_t *pte);   
// void            make_other_pte_swapped_in(pte_t *pte,char*);
...
void            initrmap(void);
void            handle_fage_fault(void);
void            read_page_from_disk(uint slot,char* mem);
