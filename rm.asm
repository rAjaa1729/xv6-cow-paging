...
free(void *ap)
{
 ...
 5b1:	a1 c8 07 00 00       	mov    0x7c8,%eax
{
 ...
 5ef:	5b                   	pop    %ebx
  freep = p;
 5f0:	a3 c8 07 00 00       	mov    %eax,0x7c8
}
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 5f7:	5d                   	pop    %ebp
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 c8 07 00 00       	mov    %eax,0x7c8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 c8 07 00 00    	mov    0x7c8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68b:	3b 05 c8 07 00 00    	cmp    0x7c8,%eax
 ...
 6ae:	e8 fd fe ff ff       	call   5b0 <free>
  return freep;
 6b3:	8b 15 c8 07 00 00    	mov    0x7c8,%edx
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6df:	89 15 c8 07 00 00    	mov    %edx,0x7c8
}
 ...
 6ef:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 c8 07 00 00 cc 	movl   $0x7cc,0x7c8
 6f7:	07 00 00 
    base.s.size = 0;
 6fa:	b8 cc 07 00 00       	mov    $0x7cc,%eax
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 cc 07 00 00 cc 	movl   $0x7cc,0x7cc
 706:	07 00 00 
    base.s.size = 0;
 709:	c7 05 d0 07 00 00 00 	movl   $0x0,0x7d0
 710:	00 00 00 
    if(p->s.size >= nunits){
