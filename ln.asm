...
free(void *ap)
{
 ...
 591:	a1 a4 07 00 00       	mov    0x7a4,%eax
{
 ...
 5cf:	5b                   	pop    %ebx
  freep = p;
 5d0:	a3 a4 07 00 00       	mov    %eax,0x7a4
}
 5d5:	5e                   	pop    %esi
 5d6:	5f                   	pop    %edi
 5d7:	5d                   	pop    %ebp
 ...
 5e6:	72 ce                	jb     5b6 <free+0x26>
{
 ...
 607:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 60a:	a3 a4 07 00 00       	mov    %eax,0x7a4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 a4 07 00 00    	mov    0x7a4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66b:	3b 05 a4 07 00 00    	cmp    0x7a4,%eax
 ...
 68e:	e8 fd fe ff ff       	call   590 <free>
  return freep;
 693:	8b 15 a4 07 00 00    	mov    0x7a4,%edx
 ...
 6bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6bf:	89 15 a4 07 00 00    	mov    %edx,0x7a4
}
 ...
 6cf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6d0:	c7 05 a4 07 00 00 a8 	movl   $0x7a8,0x7a4
 6d7:	07 00 00 
    base.s.size = 0;
 6da:	b8 a8 07 00 00       	mov    $0x7a8,%eax
    base.s.ptr = freep = prevp = &base;
 6df:	c7 05 a8 07 00 00 a8 	movl   $0x7a8,0x7a8
 6e6:	07 00 00 
    base.s.size = 0;
 6e9:	c7 05 ac 07 00 00 00 	movl   $0x0,0x7ac
 6f0:	00 00 00 
    if(p->s.size >= nunits){
