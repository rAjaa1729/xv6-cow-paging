 ...
 1f4:	31 ff                	xor    %edi,%edi
{
 ...
 21d:	50                   	push   %eax
 21e:	8d 81 00 0b 00 00    	lea    0xb00(%ecx),%eax
 224:	50                   	push   %eax
 ...
 23b:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    buf[m] = '\0';
 23e:	bf 00 0b 00 00       	mov    $0xb00,%edi
 243:	89 de                	mov    %ebx,%esi
 245:	c6 81 00 0b 00 00 00 	movb   $0x0,0xb00(%ecx)
    while((q = strchr(p, '\n')) != 0){
 ...
 2f2:	81 ff 00 0b 00 00    	cmp    $0xb00,%edi
 ...
 307:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 30a:	2d 00 0b 00 00       	sub    $0xb00,%eax
 30f:	29 45 e0             	sub    %eax,-0x20(%ebp)
 312:	8b 4d e0             	mov    -0x20(%ebp),%ecx
      memmove(buf, p, m);
 315:	51                   	push   %ecx
 316:	57                   	push   %edi
 317:	68 00 0b 00 00       	push   $0xb00
...
free(void *ap)
{
 ...
 8d1:	a1 00 0f 00 00       	mov    0xf00,%eax
{
 ...
 90f:	5b                   	pop    %ebx
  freep = p;
 910:	a3 00 0f 00 00       	mov    %eax,0xf00
}
 915:	5e                   	pop    %esi
 916:	5f                   	pop    %edi
 917:	5d                   	pop    %ebp
 ...
 926:	72 ce                	jb     8f6 <free+0x26>
{
 ...
 947:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 94a:	a3 00 0f 00 00       	mov    %eax,0xf00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 969:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 96c:	8b 15 00 0f 00 00    	mov    0xf00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9ab:	3b 05 00 0f 00 00    	cmp    0xf00,%eax
 ...
 9ce:	e8 fd fe ff ff       	call   8d0 <free>
  return freep;
 9d3:	8b 15 00 0f 00 00    	mov    0xf00,%edx
 ...
 a26:	0f 00 00 
    base.s.size = 0;
 a29:	c7 05 08 0f 00 00 00 	movl   $0x0,0xf08
 a30:	00 00 00 
    if(p->s.size >= nunits){
