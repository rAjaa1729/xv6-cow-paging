...
free(void *ap)
{
 ...
 621:	a1 64 08 00 00       	mov    0x864,%eax
{
 ...
 65f:	5b                   	pop    %ebx
  freep = p;
 660:	a3 64 08 00 00       	mov    %eax,0x864
}
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 667:	5d                   	pop    %ebp
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 64 08 00 00       	mov    %eax,0x864
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 64 08 00 00    	mov    0x864,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6fb:	3b 05 64 08 00 00    	cmp    0x864,%eax
 ...
 71e:	e8 fd fe ff ff       	call   620 <free>
  return freep;
 723:	8b 15 64 08 00 00    	mov    0x864,%edx
 ...
 74c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 74f:	89 15 64 08 00 00    	mov    %edx,0x864
}
 ...
 75f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 64 08 00 00 68 	movl   $0x868,0x864
 767:	08 00 00 
    base.s.size = 0;
 76a:	b8 68 08 00 00       	mov    $0x868,%eax
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 68 08 00 00 68 	movl   $0x868,0x868
 776:	08 00 00 
    base.s.size = 0;
 779:	c7 05 6c 08 00 00 00 	movl   $0x0,0x86c
 780:	00 00 00 
    if(p->s.size >= nunits){
