...
free(void *ap)
{
 ...
 5a1:	a1 94 07 00 00       	mov    0x794,%eax
{
 ...
 5df:	5b                   	pop    %ebx
  freep = p;
 5e0:	a3 94 07 00 00       	mov    %eax,0x794
}
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 5e7:	5d                   	pop    %ebp
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 94 07 00 00       	mov    %eax,0x794
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 94 07 00 00    	mov    0x794,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67b:	3b 05 94 07 00 00    	cmp    0x794,%eax
 ...
 69e:	e8 fd fe ff ff       	call   5a0 <free>
  return freep;
 6a3:	8b 15 94 07 00 00    	mov    0x794,%edx
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6cf:	89 15 94 07 00 00    	mov    %edx,0x794
}
 ...
 6df:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 94 07 00 00 98 	movl   $0x798,0x794
 6e7:	07 00 00 
    base.s.size = 0;
 6ea:	b8 98 07 00 00       	mov    $0x798,%eax
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 98 07 00 00 98 	movl   $0x798,0x798
 6f6:	07 00 00 
    base.s.size = 0;
 6f9:	c7 05 9c 07 00 00 00 	movl   $0x0,0x79c
 700:	00 00 00 
    if(p->s.size >= nunits){
